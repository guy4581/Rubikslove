...
def color_detect(h, s, v, side=None):

    # White detection: Must be very desaturated and bright
    if s < 10 and v > 220:
        return 'white'
    ...
    # Blue detection
    if 85 <= h < 150 and s > 20:
        return 'blue'
    
    # Default case (for undefined colors or very low saturation)
    return 'white'
